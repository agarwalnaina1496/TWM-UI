...
export default function ChoosePlan() {
  ...
  return (
    <Layout>
      <ScreenHeader
        eyebrow="Choose who handles booking and on-trip execution"
        title={<>Your itinerary is ready. <em>How should the trip run?</em></>}
        lede="This choice changes who books, uploads confirmations and handles the trip—not the itinerary you just reviewed."
      />
