...
// structured booking_setup.party a traveler later sets purely for
// booking-search precision. Those two kinds of fact have different
// lifecycles (frozen plan vs. freely-refinable booking detail) and belong
// on different surfaces (here vs. the per-item booking drawers); showing the
// booking-precision value here would look like the itinerary itself had
// changed when it hadn't. No prop threading needed either way -- both facts
// already live on finalItinerary.trip_summary.
